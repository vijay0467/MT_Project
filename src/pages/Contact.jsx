  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          backgroundImage: `url('./src/assets/contact-bg.jpg')`, // Add a relevant background image
      ...
      >
        ...
        >
          ...
          <p className="lead">
            Have a question or need support? We’re here to help. Get in touch with us below!
          </p>
        </div>
      </section>
      ...
      <section className="contact-info-section py-5 bg-dark-subtle rounded-5">
        <div className="container">
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-md-4 mb-4 text-center">
              <h5>Address</h5>
              <p>123 Mana Trendz St, Fashion City, Country</p>
            </div>
          </div>
        </div>
      </section>
